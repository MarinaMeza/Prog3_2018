...
class cd
{
	...
	public function ModificarCd()
	 ...
	 {
				$objetoAccesoDato = AccesoDatos::dameUnObjetoAcceso(); 
				$consulta =$objetoAccesoDato->RetornarConsulta("INSERT into tabla (valor_char,valor_date,valor_int)values('$this->valor_char','$this->calor_date','$this->valor_int')");
				$consulta->execute();
	 ...
	 {
				$objetoAccesoDato = AccesoDatos::dameUnObjetoAcceso(); 
				$consulta =$objetoAccesoDato->RetornarConsulta("INSERT into tabla (valor_char,valor_date,valor_int)values(:valor_char,:valor_date,:valor_int)");
				$consulta->bindValue(':valor_char',$this->valor_char, PDO::PARAM_INT);
				$consulta->bindValue(':valor_date', $this->valor_date, PDO::PARAM_STR);
				$consulta->bindValue(':valor_int', $this->valor_int, PDO::PARAM_STR);
				$consulta->execute();		
				return $objetoAccesoDato->RetornarUltimoIdInsertado();
	 }
